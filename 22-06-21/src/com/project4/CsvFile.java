...
public class CsvFile implements Comparable<CsvFile> {
	private static final TreeSet<CsvFile> person = null;
	int i; String S;
	static String words;
	CsvFile(int i,String S){
		this.i = i;
		this.S = S;
	}
	...
	public static void main(String[] args)throws Exception{
		Set<CsvFile> obj= new TreeSet<CsvFile>();
		File inputFile = new File("C:\\Users\\BCP\\Desktop\\csvsam.csv");
	File outputFile = new File("C:\\Users\\BCP\\Desktop\\csvsam2.csv");
	...
	try
	{
		...
		while((words = read2.readLine())!=null){
			...
			CsvFile person = new CsvFile(Integer.parseInt(separate[0]),separate[1]);
			obj.add(person);
		}
		System.out.println(obj);
		for(CsvFile sorted:obj) {
